            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Tabel Data Pengembalian Buku</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                    <?php 
                                    $cat = mysqli_query($koneksi, "select * from logs where jenis = 'kembali'");
                                    while($c = mysqli_fetch_array($cat)){
                                        ?>
                                            <tr>
                                            <td><?php echo $c['hari'] ?></td>
                                            <td><?php echo $c['email'] ?></td>
                                            <td><?php echo $c['id_buku'] ?></td>
                                            <td><?php echo $c['banyak'] ?></td>
                                        </tr>
                                        <?php 
                                    }
                                    ?>
