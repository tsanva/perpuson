    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Tabel Kategori Buku</h1>
         ...
         <table align="center" width="795" border="2" bgcolor="#FFFFFF">
            ...
            <tr align="center">
                <td colspan="7"><h2>Tambah Kategori Buku</h2></td>
            </tr>
            <tr>
                <td align="right"><b>Kategori Buku:</b></td>
                <td><input type="text"  name="kategoribuku" size="60" required/></td>
            </tr>
            
        
            
            <tr align="center">
                <td colspan="7"><input type="submit" name="input_kategori" class="btn btn-primary" value="Tambah Kategori"/></td>
            </tr>
                            ...
                            <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                 <a href="hapuskategori.php?id=<?php echo $c['name']; ?>"><button class="tmbl tmbl-masuk">Hapus</button></a> -- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong">Launch demo modal</button>
                                            </td>
                                        </tr>
                                        <?php 
                                    }
...
<?php 
    ...
    if(isset($_POST['input_kategori'])){
        ...
        $kategoribuku = $_POST['kategoribuku'];
         ...
         $insert_kategori = "INSERT INTO category (name) VALUES ('$kategoribuku')";
         
         $insert_kat = mysqli_query($koneksi, $insert_kategori);
         
         if($insert_kat){
         
         echo "<script>alert('Penambahan Kategori Sukses')</script>";
